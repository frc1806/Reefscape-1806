 ...
 */
public class AbsoluteFieldDriveCurrentAngle extends Command
{
   ...
   */
  public AbsoluteFieldDriveCurrentAngle(SwerveSubsystem swerve, DoubleSupplier vX, DoubleSupplier vY)
  {
    this.swerve = swerve;
    this.vX = vX;
    this.vY = vY;
