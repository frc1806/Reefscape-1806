...
public class SwerveInputStream implements Supplier<ChassisSpeeds>
{
  ...
  public SwerveInputStream withSnappedControllerHeadingAxis(FieldSnapAngles fieldSnapAngles, DoubleSupplier headingX, DoubleSupplier headingY)
  {
    controllerHeadingX = Optional.of(new DoubleSupplier(){

      @Override
      public double getAsDouble() {
        Translation2d inputTranslation2d = new Translation2d(headingX.getAsDouble(), headingY.getAsDouble());
        double dist = Math.abs(inputTranslation2d.getDistance(Translation2d.kZero));
        if(dist == 0) return 0.0;
        return new Translation2d(dist, fieldSnapAngles.getNearestSnapAngle(inputTranslation2d.getAngle().getRadians())).getX();
      }
    });

      controllerHeadingY = Optional.of(new DoubleSupplier(){
        ...
        public double getAsDouble() {
          ...
          double dist = Math.abs(inputTranslation2d.getDistance(Translation2d.kZero));
          if(dist == 0) return 0.0;
          return new Translation2d(dist, fieldSnapAngles.getNearestSnapAngle(inputTranslation2d.getAngle().getRadians())).getY();
